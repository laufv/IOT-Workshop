///////////////////////// Bibliotheken einbinden und globale Variablen definieren
...
static void LDR_send(void);

// die setup Funktion wird zu Beginn nur ein Mal ausgeführt
void setup(void) {
	common_setup();
	delay(500);
}

// die loop Funktion wird anschließend kontinuierlich ausgeführt
void loop(void) {
...
//////////////////////////////////// Beginn des Codes für den LDR
#define LDR_PIN ***
int sensor_value;

static void LDR_send() {
